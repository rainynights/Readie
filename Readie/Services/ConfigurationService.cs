...
public static class ConfigurationService
{
    ...
    private static ReadingOptions _readingOptions;
    public static ReadingOptions ReadingOptions
    {
        get
        {
            if (_text == null)
